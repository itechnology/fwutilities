...
{
    /// <summary>
    /// Provides data for ServiceStarted event.
    /// </summary>
    public class ServiceStartedEventArgs : EventArgs
    {
        /// <summary>
        /// Initializes a new instance of the ServiceStartedEventArgs class.
        /// </summary>
        /// <param name="args">Service args.</param>
        /// <exception cref="ArgumentNullException">args is null.</exception>
        public ServiceStartedEventArgs(string[] args)
        {
            if (args == null)
            {
