...
namespace FileWatcherUtilities.Controller
{
    ...
    /// </summary>
    public class ControllerProcessStartedEventArgs : EventArgs
    {
        /// <summary>
        /// Initializes a new instance of the ControllerProcessStartedEventArgs class.
        /// </summary>
        ...
        public ControllerProcessStartedEventArgs(string daemonName,
                                                 int processId,
                                                 string fileName,
                                                 string arguments,
                                                 string verb,
