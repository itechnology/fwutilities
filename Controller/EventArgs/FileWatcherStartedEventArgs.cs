...
{
    /// <summary>
    /// Provides data for FileWatcherStarted event.
    /// </summary>
    public class FileWatcherStartedEventArgs : EventArgs
    {
        /// <summary>
        /// Initializes a new instance of the FileWatcherStartedEventArgs class.
        /// </summary>
        ...
        public FileWatcherStartedEventArgs(string daemonName)
        {
            if (daemonName == null)
            {
