...
{
    /// <summary>
    /// Provides data for FileWatcherStopped event.
    /// </summary>
    public class FileWatcherStoppedEventArgs : EventArgs
    {
        /// <summary>
        /// Initializes a new instance of the FileWatcherStoppedEventArgs class.
        /// </summary>
        /// <param name="daemonName">Daemon name of the file stopped watcher.</param>
        /// <exception cref="ArgumentNullException">daemonName is null.</exception>
        public FileWatcherStoppedEventArgs(string daemonName)
        {
            if (daemonName == null)
            {
