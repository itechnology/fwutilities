...
{
    /// <summary>
    /// Provides data for FileSystemSearchProgress event.
    /// </summary>
    public class FileSystemSearcherProgressEventArgs : EventArgs
    {
        /// <summary>
        /// Initializes a new instance of the FileSystemSearcherProgressEventArgs class.
        /// </summary>
        ...
        public FileSystemSearcherProgressEventArgs(string directoryFullPath)
        {
